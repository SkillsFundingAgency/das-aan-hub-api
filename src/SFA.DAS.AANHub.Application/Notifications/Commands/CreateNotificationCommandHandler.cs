...
public class CreateNotificationCommandHandler : IRequestHandler<CreateNotificationCommand, ValidatedResponse<CreateNotificationCommandResponse>>
{
    ...
    {
        var notification = NotificationHelper.CreateNotification(Guid.NewGuid(), contactMember.Id, notificationTemplate.TemplateName, tokens, requestedByMember.Id, false, contactMember.Id.ToString());
