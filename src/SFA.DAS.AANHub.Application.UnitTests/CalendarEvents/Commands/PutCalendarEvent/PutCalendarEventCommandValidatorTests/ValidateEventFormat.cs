...
public class ValidateEventFormat
{
    ...
    public async Task Validate_EventFormat_ShouldBeValidValue(EventFormat? eventFormat, bool isValid)
    {
        ...
        PutCalendarEventCommand command = new() { AdminMemberId = PutCalendarEventCommandValidatorBuilderExtensions.ToGuid(PutCalendarEventCommandValidatorBuilder.AdminActiveMemberId), EventFormat = eventFormat };
