...
public class ValidateEventLink
{
    ...
    [TestCase(EventFormat.Online, 2001, "", false, ErrorConstants.EventLinkMustNotExceedLength)]
    [TestCase(EventFormat.Hybrid, 2001, "", false, ErrorConstants.EventLinkMustNotExceedLength)]
