...
namespace SFA.DAS.AANHub.Application.UnitTests.Admins.Commands
{
    public class CreateAdminMemberCommandValidatorTests
    {
        ...
        public CreateAdminMemberCommandValidatorTests() => _regionsReadRepository = new Mock<IRegionsReadRepository>();
        ...
        public async Task Validates_UserName_NotNullOrEmpty(string? userName, bool isValid)
        {
            ...
            var sut = new CreateAdminMemberCommandValidator(_regionsReadRepository.Object);
        ...
        public async Task Validates_UserName_Length(int length, bool isValid)
        {
            ...
            var command = new CreateAdminMemberCommand() { UserName = new string('a', length) };
            var sut = new CreateAdminMemberCommandValidator(_regionsReadRepository.Object);
