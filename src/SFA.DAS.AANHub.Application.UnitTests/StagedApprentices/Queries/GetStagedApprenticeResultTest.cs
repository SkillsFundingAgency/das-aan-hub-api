...
namespace SFA.DAS.AANHub.Application.UnitTests.StagedApprentices.Queries
{
    ...
    {
        [Test, AutoMoqData]
        public void Apprentice_ReturnsExpectedFields(StagedApprentice stagedApprentice)
        {
        ...
        [Test, AutoMoqData]
        public void StagedApprentice_GetStagedApprenticeResultTest_StagedApprenticeIsNull()
        {
